...
export const mint = async (walletAddress: string) => {
    ...
    const transactionBuilder = await metaplex.nfts().builders().create({
        uri: "https://res.cloudinary.com/dnjbui12k/raw/upload/v1685618330/the_lollypop_metadata_mb7j7t.json", // replace with with solana NFT standard compatible JSON file
        name: "Lollypop Galaxy", //name of your NFT
        symbol: "LG", //symbol of your NFT
